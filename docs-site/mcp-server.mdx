---
title: 'MCP server'
description: 'Seven tools that let an agent resolve wallets to social identities, over the same API and the same balance.'
---
...
Eight endpoints become seven tools because the single and batch lookups answer
...
completion runs and bills again. At zero balance the three free tools keep
