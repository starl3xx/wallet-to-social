...
<Note>
  ...
  (`Developer`, `Startup`), which does not match the pack you purchased. Every
  pack reports `Developer`. `Startup` appears only on legacy Unlimited accounts.
  The mapping above is the whole of it.
</Note>
