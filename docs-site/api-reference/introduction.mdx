...
### Buying a pack, and the terms

A pack is bought with a card at
[walletlink.social/pricing](https://walletlink.social/pricing), or with USDC
over x402, no account needed, as the [agent pack](/agent-pack). Either way you
agree to the [terms of service](https://walletlink.social/terms). Card
checkout asks you to tick “I agree to the Terms of Service” before it opens
Stripe. On x402, the `402` challenge names the terms and their version, and
paying it is the agreement. The purchase records which version you agreed to,
and when.

Signing in to the website records no agreement to the terms. The sign-in form
carries a notice instead: by continuing you agree to the terms and acknowledge
the [privacy policy](https://walletlink.social/privacy). Card checkout links
the privacy policy too, on a line under the box, as a notice and not as part
of the agreement.
