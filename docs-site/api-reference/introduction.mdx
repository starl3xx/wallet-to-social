...
Signing in to the website records nothing. The sign-in form carries a notice
instead: by continuing you agree to the terms and acknowledge the
[privacy policy](https://walletlink.social/privacy). Card checkout links the
privacy policy too, on a line under the box, as a notice and not as part of
the agreement.
