...
| `BATCH_SIZE_EXCEEDED` | 400    | More wallets than your batch limit: 50, or 200 on a legacy Unlimited account.                       |
| `NO_CREDITS`          | 402    | Match credit balance is exhausted, or the free 30-day allowance is used up. Buy a pack to continue. |
