...
Finds every wallet linked to a Farcaster username. Costs **1 match credit per wallet returned**, up to 100. A username with no wallets attached costs nothing. Separately, it weighs 2 units against your rate limit.
