...
The paying wallet is screened against sanctions lists as soon as the paid
request arrives, and purchases are not available from a country or region
under comprehensive US sanctions. These refusals happen **before anything is
verified or settled**, so nothing is charged:
...
An account whose paying wallet is found on a sanctions list after it bought
is suspended: its keys stop working, its credits are held, and
