...
suspended: its keys stop working, its credits are held, it cannot buy more
(`403` `SANCTIONED_PAYER`, card checkout included), and
[key recovery](#lost-your-key) answers `403` `SANCTIONED_PAYER`.
