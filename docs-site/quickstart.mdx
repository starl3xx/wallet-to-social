...
<Steps>
  ...
  <Step title="Export">
    ...
    list import. Both exports come with any pack; free lookups show results on
    screen.
  </Step>
</Steps>
...
One address at a time gets slow quickly. [`POST /api/v1/batch`](/api-reference/batch) takes up to 50 addresses per request:
