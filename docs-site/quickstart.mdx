...
Email [help@walletlink.social](mailto:help@walletlink.social) from the address on your account and we will issue a key. Keys look like `wts_live_` followed by 32 characters.
