...
**The index is our own database of wallet identities.** It is not a cache in front of somebody else's API, and it is not assembled per request. It is 5 million wallets that we resolved, verified and stored ourselves, including complete coverage of the Farcaster protocol, and it is refreshed every day.
