...
To report a security vulnerability, follow the [security policy](https://github.com/starl3xx/wallet-to-social/security/policy). The preferred channel is a private report on GitHub; email to help@ works too. The same contacts are in [security.txt](https://walletlink.social/.well-known/security.txt).
