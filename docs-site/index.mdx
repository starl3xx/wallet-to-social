...
To report a security vulnerability, use one of the private channels in the [security policy](https://github.com/starl3xx/wallet-to-social/security/policy) instead. The same contacts are in [security.txt](https://walletlink.social/.well-known/security.txt).
