...
const competitors = [
  {
    ...
    summary:
      'Web3 CRM platform focused on wallet-based marketing automation. Enterprise-focused with complex onboarding.',
    angle:
      'Full CRM suite approach - marketing automation, campaigns, analytics',
  ...
  },
  {
    ...
    url: 'https://blaze.xyz',
    summary:
      'Growth platform with wallet enrichment, community tools, and campaign management. Subscription-based.',
  ...
  },
  {
    ...
    summary:
      'Analytics platform for understanding token holder composition. Focus on holder segmentation and trends.',
