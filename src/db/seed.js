...
const competitors = [
  {
    ...
    summary:
      'Enterprise blockchain analytics with entity identification. Expensive, complex, focused on investigation/compliance.',
  ...
  },
  {
    ...
    summary:
      'Free but very limited. Only labels major addresses (exchanges, contracts). No social profiles.',
  ...
  },
  {
    ...
    url: 'https://nansen.ai',
    summary:
      'Great for tracking smart money and wallet categories. Enterprise pricing. Focus on trading/DeFi analytics.',
...
const trends = [
  {
    ...
    description:
      'Farcaster daily active users up 10x in 2024. Frames driving viral adoption. Becoming the "crypto Twitter" for builders.',
  ...
  },
  {
    ...
    description:
      'Moving beyond "hold NFT to access Discord." Projects building sophisticated holder engagement, rewards, and governance.',
  ...
  },
  {
    ...
    description:
      'ENS becoming the de facto identity layer for Web3. Text records storing Twitter, email, and other socials.',
  ...
  },
  {
    ...
    description:
      'Projects moving away from broad airdrops. Focus on quality distribution to engaged users, not farmers.',
...
const research = [
  {
    ...
    summary:
      'Analysis of 500K+ wallet addresses across different token communities to establish match rate benchmarks',
  ...
  },
  {
    ...
    summary:
      'Study on how communities with identified members differ from those with purely anonymous holders',
    findings: JSON.stringify([
  ...
  },
  {
    ...
    summary:
      'How combining token holdings with social follower count creates better holder prioritization',
    findings: JSON.stringify([
    ...
    data: JSON.stringify([
      {
        metric: 'Top priority holders organic reach contribution',
        value: '70%',
      },
      {
        metric: 'Average whale with low reach',
        value: '$50K holdings, 200 followers',
      },
      {
        metric: 'Average influencer with low holdings',
        value: '$500 holdings, 50K followers',
      },
    ]),
...
const communications = [
  {
    ...
    details:
      'Added Neynar API integration for Farcaster lookups. Now returns Farcaster usernames, follower counts, and verified Twitter handles. Major accuracy improvement.',
  ...
  },
  {
    ...
    details:
      'DAO used wallet-to-social to identify their most engaged holders with social presence. Direct outreach to top 200 holders resulted in 4x governance participation.',
    messages: JSON.stringify([
  ...
  },
  {
    ...
    details:
      'New priority scoring system that combines token holdings with social follower count. Helps identify your most valuable community members.',
    messages: JSON.stringify([
  ...
  },
  {
    ...
    details:
      'Backend optimizations for handling large datasets. Streaming progress updates. Concurrent API calls. 24-hour caching.',
    messages: JSON.stringify([
...
const patterns = [
  ...
  },
  {
    ...
    example:
      '"22% match rate vs 2.5% industry average. That\'s 9x more identified holders."',
    score: 89,
  },
  {
    type: 'structure',
    ...
    example:
      'Show the pain, prove data is available, explain aggregation, share metrics',
    score: 87,
  },
  {
    type: 'angle',
...
console.log(
  `   - ${founderContent.length} founder content pieces (for voice analysis)`
);
console.log(`   - 1 wallet-to-social voice profile`);
console.log(
  `   - ${competitors.length} competitor analyses (Arkham, Etherscan, Nansen)`
);
console.log(
  `   - ${trends.length} Web3 trends (Farcaster, token-gating, ENS, airdrops)`
);
console.log(
  `   - ${research.length} research studies (match rates, engagement, priority scoring)`
);
