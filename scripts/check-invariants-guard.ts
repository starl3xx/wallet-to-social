...
const MUTATIONS: Mutation[] = [
  ...
  },
  {
    ...
    file: 'lib/oauth/grants.ts',
    from: '      sql`${oauthGrants.refreshTokenHash} = ${hash} OR ${oauthGrants.previousRefreshTokenHash} = ${hash}`',
