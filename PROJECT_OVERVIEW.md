...
under 10 wallets run inline; larger ones run their first slice straight after
the response (`after()`) and one slice a minute after that in the cron worker.
