...
| `lookup_jobs`               | Background job queue. Payloads (the submitted addresses and raw results) are stripped at 30 days by the cleanup cron; the job record itself stays. One pipeline works it, `processJobChunk`, and one invocation at a time: the claim is a conditional UPDATE that sets `leased_until` for 330 seconds, longer than any route that holds it lives, and every exit hands it back (STA-44)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | status, wallets[], processed_count, partial_results, twitter_found, leased_until                                                                                                                                                                   |
