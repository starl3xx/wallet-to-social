...
| `sanctions_screenings`      | One row per screening of a USDC payer: the address, the publish date of the list it was screened against, the verdict (`clear`, `listed`, `stale`, `missing`) and the time. Kept 5 years, then deleted by the daily cleanup; in the nightly backup                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | address, list_publish_date, verdict, screened_at                                                                                                                                                                                                   |
...
Each screening is recorded in `sanctions_screenings`. The list is built from
...
deactivated and refused by `lookupActiveKey` even if minted later, and new work
and unlocks refused (`lib/account-freeze.ts`). Nothing is refunded. Both
...
IR, KP, SY and UA-43, UA-40, UA-14, UA-09) with 403 `REGION_RESTRICTED`. The
refresh alerts on the admin health panel; the runbook is in
`docs/OPERATIONS.md`.
