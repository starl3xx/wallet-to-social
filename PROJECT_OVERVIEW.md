...
| `lookup_history`            | Saved lookup sessions. At most one per job: `job_id` is unique and a job saves with ON CONFLICT DO NOTHING, so a finalize that runs twice saves once (STA-44)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | user_id, wallet_count, results (JSONB), input_source                                                                                                                                                                                               |
