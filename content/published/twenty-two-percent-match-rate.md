...
# The day the update note below was written, from git log for this file.
# Authored, never the clock: scripts/check-invariants.ts refuses a
# structured-data date that comes from a clock read.
