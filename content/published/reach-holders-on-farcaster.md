...
For anything more than 50 wallets, you need a resolution tool. Export your holder list from Etherscan, Dune, or your preferred analytics platform. Upload the CSV to [walletlink.social](https://walletlink.social) and filter the results for Farcaster matches.

At current resolution rates, roughly 22% of active Ethereum wallets map to a social identity, and Farcaster accounts make up a growing share of those matches. For a typical token with 5,000 holders, expect 600-800 Farcaster profiles.
...
Here is a practical segmentation framework:
...
- Generic templates that obviously went to 500 people.
- Asking them to do something in the first message (vote, share, buy more).
- Pretending the outreach is not outreach. People respect transparency.
...
**Monthly holder update (channel or cast):**
A public cast thread summarizing what happened in the last month. Tag the Farcaster channel for your project. This is broadcast, but targeted broadcast to people who opted into your channel.

**Quarterly personal check-in (top holders):**
...
```
Week 1:  Monthly public update cast
Week 2:  Personal check-ins with top holders (rotate through list)
Week 3:  Event-driven outreach if applicable
...
- What they said (summarized)
- Follow-up action items

This does not need to be sophisticated. A Google Sheet works. The point is to build institutional memory so your outreach improves over time and you do not contact the same person with the same message twice.

Track your aggregate metrics too:
...
Start with your holder list. Resolve the identities. Segment the results. Send the first message. Measure what happens. Iterate.
