...
export const SOCIAL_CARDS: Record<string, SocialCard> = {
  ...
  'holder-list-to-x-list': {
    variant: 'claim',
    kicker: 'holders, findable',
    headline: 'turn a holder list into an X list',
    emphasisWord: 'X list',
    sub: 'live handles only, built into your own account, public so the community can follow it',
    cta: 'try it · walletlink.social',
    statTone: 'plain',
  },
  'x-list-live-only': {
    variant: 'claim',
    kicker: 'who goes in the list',
    headline: 'a renamed handle now belongs to a stranger',
    emphasisWord: 'stranger',
    sub: 'it resolves, it is active, it is not the person who attested it. those never go in',
    cta: 'read the story · walletlink.social/blog/holder-list-to-x-list',
    statTone: 'plain',
  },
  'reverse-lookup': {
    variant: 'claim',
  ...
  /* ---- days 15 to 28, added 2026-09-16 with the tagged links ---- */

  'chain-gap': {
    variant: 'split',
    kicker: `reachable holders by chain, measured ${CHAIN_MATCH_RATES_MEASURED_ON}`,
    headline: 'the chain decides the rate',
    emphasisWord: 'chain',
    stat: `${CHAIN_MATCH_RATES.base.either_pct}%`,
    statLabel: 'Base collections',
    stat2: `${CHAIN_MATCH_RATES.ethereum.either_pct}%`,
    stat2Label: 'Ethereum collections',
    sub: 'reachable on X or Farcaster, across 26 collections',
    cta: 'read a report free · walletlink.social/holders',
    statTone: 'attested',
  },
  'no-sales-call': {
    variant: 'stat',
    kicker: 'what it costs to start',
    headline: 'no call, no contract, no seats',
    emphasisWord: 'contract',
    stat: `$${PACKS.trial.priceCents / 100}`,
    statLabel: `${PACKS.trial.matches} matches, credits good ${CREDIT_LIFETIME_MONTHS} months`,
    sub: 'upload a list, pay for the wallets that resolve, export',
    cta: 'compare · walletlink.social/vs/addressable',
    statTone: 'brand',
  },
  'agent-wallets': {
    variant: 'stat',
    kicker: 'wallets that are not people',
  ...
  'agent-can-call': {
    variant: 'claim',
    kicker: 'MCP server',
    headline: 'your agent runs the lookup itself',
    emphasisWord: 'itself',
    sub: 'OAuth or an API key, drawing the credits the account already holds, with no developer plan and no second bill',
    cta: 'add it to your client · walletlink.social/mcp',
    statTone: 'plain',
  },
  'misses-free': {
    variant: 'stat',
    kicker: 'what a wallet costs',
    headline: 'a miss costs nothing',
    emphasisWord: 'nothing',
    stat: String(FREE_MATCHES_PER_WINDOW),
    statLabel: `free matches every ${FREE_WINDOW_DAYS} days`,
    sub: 'charged per match, never per wallet submitted, and on most lists the misses are the majority',
    cta: 'the price sheet · walletlink.social/pricing',
    statTone: 'brand',
  },
  'handle-vs-person': {
    variant: 'split',
    kicker: 'two different questions',
    headline: 'attested is not the same as reachable',
    emphasisWord: 'reachable',
    stat: `${X_LIVE_PCT}%`,
    statLabel: 'handles live today',
    stat2: `${X_SUSPENDED_PCT}%`,
    stat2Label: 'suspended today',
    sub: 'attestation is a fact about the past; reachability is a fact about now',
    cta: 'check any handle · walletlink.social/check',
    statTone: 'attested',
  },
  'who-not-what': {
    variant: 'claim',
    kicker: 'analytics or outreach',
    headline: 'what they did, or who to talk to',
    emphasisWord: 'who',
    sub: 'two different jobs, and if you only need the second you should not be paying for a suite that does the first',
    cta: 'side by side · walletlink.social/vs/cookie3',
    statTone: 'plain',
  },
  'credits-keep': {
    variant: 'stat',
    kicker: 'no subscription',
    headline: 'buy once, spend it when you need it',
    emphasisWord: 'once',
    stat: String(CREDIT_LIFETIME_MONTHS),
    statLabel: 'months before credits expire',
    sub: 'a launch this week and the next one in spring, off the same balance',
    cta: 'the packs · walletlink.social/pricing',
    statTone: 'brand',
  },
  'attested-x': {
    variant: 'stat',
    kicker: 'X handles in the index',
    headline: 'published, never guessed',
    emphasisWord: 'published',
    stat: WALLETS_WITH_X.replace(' million', 'M'),
    statLabel: 'wallets carrying an X handle',
    sub: 'almost every one written by the owner onchain or verified inside a protocol, and not one read off a bio',
    cta: 'see the method · walletlink.social',
    statTone: 'attested',
  },
  'one-upload': {
    variant: 'stat',
    kicker: 'CSV in, handles out',
    headline: 'eight chains, one upload',
    emphasisWord: 'one',
    stat: String(FREE_MATCHES_PER_WINDOW),
    statLabel: `free matches every ${FREE_WINDOW_DAYS} days`,
    sub: 'X handles and Farcaster accounts with follower counts, exported as CSV or straight into an X list',
    cta: 'start with your list · walletlink.social',
    statTone: 'brand',
  },
  'read-the-report': {
    variant: 'claim',
    kicker: 'holder reports',
    headline: 'already resolved, free to read',
    emphasisWord: 'free',
    sub: 'how many holders, how many reachable on X or Farcaster, and which chain they sit on',
  ...
  'holder-sunset': {
    variant: 'claim',
    kicker: 'holder.xyz shut down',
    headline: 'the lists went with it',
    emphasisWord: 'went',
    sub: 'if you are still carrying that CSV around, this is what moving looks like',
    cta: 'the migration · walletlink.social/vs/holder',
    statTone: 'plain',
  },
  'same-balance': {
    variant: 'claim',
    kicker: 'API and app',
    headline: 'one balance, either way in',
    emphasisWord: 'one',
    sub: 'no developer tier, no separate key price, no monthly minimum: buy a pack and spend it from a browser or from code',
    cta: 'the agent surface · walletlink.social/mcp',
    statTone: 'plain',
  },
};
